   ...
   public class RenderState
   {
      ...
      public function copyFrom(param1:RenderState) : void
      {
         ...
         if(_onDrawRequired != null)
         {
            ...
            _loc5_ = (_miscOptions & 0x0F00) != (param1._miscOptions & 0x0F00);
      ...
      public function setRenderTarget(param1:Texture, param2:Boolean = true, param3:int = 0) : void
      {
         ...
         var _loc7_:uint = uint(MathUtil.min(param3,15) | uint(param2) << 4);
         var _loc4_:* = _loc7_ != (_miscOptions & 0xFF);
      ...
      {
         var _loc1_:* = (_miscOptions & 0x0F00) >> 8;
      ...
      public function set culling(param1:String) : void
      {
         ...
         if(this.culling != param1)
         {
            ...
            _loc2_ = int(CULLING_VALUES.indexOf(param1));
            if(_loc2_ == -1)
            {
