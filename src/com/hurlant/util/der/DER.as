      ...
      public static function parse(param1:ByteArray, param2:* = null) : IAsn1Type
      {
         ...
         switch(_loc11_)
         {
            ...
            case 5:
               return null;
            case 19:
               _loc22_ = new PrintableString(_loc11_,_loc9_);
            ...
            case 20:
               ...
               return _loc22_;
            case 23:
               _loc8_ = new UTCTime(_loc11_,_loc9_);
               _loc8_.setUTCTime(param1.readMultiByte(_loc9_,"US-ASCII"));
               return _loc8_;
         }
