   ...
   public class Tracker implements GoogleAnalyticsAPI
   {
      ...
      private function _formatReferrer() : String
      {
         ...
         else
         {
            ...
            _loc3_ = new uri(_loc1_);
            _loc4_ = new uri("http://" + _loc2_);
            if(_loc3_.host == _loc2_)
            {
               return "-";
            }
            _loc5_ = getDomainFromHost(_loc3_.host);
            _loc6_ = getSubDomainFromHost(_loc3_.host);
            _loc7_ = getDomainFromHost(_loc4_.host);
            _loc8_ = getSubDomainFromHost(_loc4_.host);
            if(_loc7_ == _loc5_)
            {
               if(_loc8_ != _loc6_)
               {
      ...
      private function _generateUserDataHash() : Number
      {
         ...
         _loc1_ += this._info.userAgent;
         _loc1_ += this._info.screenWidth + "x" + this._info.screenHeight + this._info.screenColorDepth;
         _loc1_ += this._info.referrer;
         return generateHash(_loc1_);
      }
      
      private function _getUniqueSessionId() : Number
      {
         var _loc1_:Number = (generate32bitRandom() ^ this._generateUserDataHash()) * 2147483647;
      ...
      public function setCampContentKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampContentKey( " + this._config.campaignKey.UCCT + " )";
      ...
      public function setCampMediumKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampMediumKey( " + this._config.campaignKey.UCMD + " )";
         if(this._debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampNameKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampNameKey( " + this._config.campaignKey.UCCN + " )";
         if(this._debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampNOKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampNOKey( " + this._config.campaignKey.UCNO + " )";
         if(this._debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampSourceKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampSourceKey( " + this._config.campaignKey.UCSR + " )";
         if(this._debug.mode == VisualDebugMode.geek)
         {
      ...
      public function setCampTermKey(param1:String) : void
      {
         ...
         var _loc2_:String = "setCampTermKey( " + this._config.campaignKey.UCTR + " )";
         if(this._debug.mode == VisualDebugMode.geek)
         {
