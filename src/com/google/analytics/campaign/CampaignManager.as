package com.google.analytics.campaign
{
   ...
   public class CampaignManager
   {
      ...
      public static function isInvalidReferrer(param1:String) : Boolean
      {
         ...
         if(_loc2_.scheme == "file" || _loc2_.scheme == "")
         {
            return true;
         }
         return false;
      ...
      public static function isFromGoogleCSE(param1:String, param2:Configuration) : Boolean
      {
         ...
         if(_loc3_.host.indexOf(param2.google) > -1)
         {
            if(_loc3_.path == "/" + param2.googleCsePath && _loc3_.query.indexOf(param2.googleSearchParam + "=") > -1)
            {
               return true;
            }
         }
      ...
      public function getOrganicCampaign() : CampaignTracker
      {
         ...
         var _loc2_:uri = new uri(this._referrer);
         if(_loc2_.host != "" && _loc2_.host.indexOf(".") > -1)
         {
            _loc4_ = _loc2_.host.split(".");
         ...
         if(this._config.organic.match(_loc3_))
         {
            ...
            _loc6_ = this._config.organic.getKeywordValue(_loc5_,_loc2_.query);
