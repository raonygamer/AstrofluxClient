   ...
   public class URI
   {
      ...
      public static function fastEscapeChars(param1:String, param2:URIEncodingBitmap) : String
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            _loc5_ = param2.ShouldEscape(_loc3_);
            if(_loc5_)
            {
      ...
      protected function parseURI(param1:String) : Boolean
      {
         ...
         _loc3_ = int(_loc7_.search(":"));
         _loc5_ = int(_loc7_.search("/"));
         var _loc6_:* = _loc3_ != -1;
         var _loc4_:* = _loc5_ != -1;
         var _loc2_:Boolean = !_loc4_ || _loc3_ < _loc5_;
         if(_loc6_ && _loc2_)
         {
            _scheme = _loc7_.substr(0,_loc3_);
            _scheme = _scheme.toLowerCase();
            _loc7_ = _loc7_.substr(_loc3_ + 1);
      ...
      public function getRelation(param1:URI, param2:Boolean = true) : int
      {
         ...
         if(_loc9_.length < _loc5_.length)
         {
            _loc13_ = _loc9_[_loc9_.length - 1];
            if(_loc13_.length > 0)
            {
               return 0;
            }
      ...
      public function getCommonParent(param1:URI, param2:Boolean = true) : URI
      {
         ...
         var _loc4_:int = _loc7_.getRelation(_loc3_);
         if(_loc4_ == 0)
         {
            return null;
         }
         ...
         while(true)
         {
            _loc4_ = _loc7_.getRelation(_loc3_,param2);
      ...
      public function chdir(param1:String, param2:Boolean = false) : Boolean
      {
         ...
         _loc14_ = new URI(_loc11_);
         if(_loc14_.isAbsolute() || _loc14_.isHierarchical() == false)
         {
            copyURI(_loc14_);
            return true;
         }
      ...
      public function makeRelativeURI(param1:URI, param2:Boolean = true) : Boolean
      {
         ...
         var _loc15_:String = null;
         var _loc11_:int = 0;
         var _loc14_:URI = new URI();
         _loc14_.copyURI(param1);
         var _loc5_:Array = [];
         ...
         _loc6_ = joinPath(_loc5_,false,_loc9_);
         if(_loc6_.length == 0)
         {
            _loc6_ = "./";
         }
