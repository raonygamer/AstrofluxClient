   ...
   public class HexColorsPlugin extends TweenPlugin
   {
      ...
      public function _initColor(param1:Object, param2:String, param3:uint) : void
      {
         ...
         if(_loc7_ != param3)
         {
            ...
            var _loc4_:uint = uint(_loc7_ >> 8 & 0xFF);
            var _loc5_:uint = uint(_loc7_ & 0xFF);
            _colors[_colors.length] = new ColorProp(param1,param2,_loc8_,_loc6_,(param3 >> 16) - _loc6_,_loc4_,(param3 >> 8 & 0xFF) - _loc4_,_loc5_,(param3 & 0xFF) - _loc5_);
