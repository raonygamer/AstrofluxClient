      ...
      public static function _parseBezierData(param1:Array, param2:String, param3:Object = null) : Object
      {
         ...
         while(true)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               _loc8_ = Number(param3 == null ? param1[_loc10_][_loc14_] : (typeof _loc15_ === "string" && _loc15_.charAt(1) === "=" ? param3[_loc14_] + (_loc15_.charAt(0) + _loc15_.substr(2)) : Number(_loc15_)));
               if(_loc11_)
               {
                  if(_loc10_ > 1)
                  {
      ...
      private static function _addCubicLengths(param1:Array, param2:Array, param3:uint = 6) : void
      {
         ...
         while(true)
         {
            ...
            while(_loc10_ <= param3)
            {
               ...
               _loc16_ = 1 - _loc15_;
               _loc5_ = _loc12_ - (_loc12_ = (_loc15_ * _loc15_ * _loc6_ + 3 * _loc16_ * (_loc15_ * _loc7_ + _loc16_ * _loc8_)) * _loc15_);
