package feathers.core
{
   ...
   public class DefaultFocusManager implements IFocusManager
   {
      ...
      public function set focus(param1:IFocusDisplayObject) : void
      {
         ...
         {
            _loc6_ = INativeFocusOwner(_loc4_).nativeFocus;
         ...
         if(this._isEnabled)
         {
            if(this._focus !== null)
            {
               ...
               {
                  _loc6_ = INativeFocusOwner(this._focus).nativeFocus;
                  if(_loc6_ is InteractiveObject)
                  {
                  ...
                  else if(_loc6_ !== null)
                  {
                     ...
                     _loc5_ = IAdvancedNativeFocusOwner(this._focus);
                     if(!_loc5_.hasFocus)
                     {
                        _loc5_.setFocus();
                     }
      ...
      protected function findPreviousContainerFocus(param1:DisplayObjectContainer, param2:DisplayObject, param3:Boolean) : IFocusDisplayObject
      {
         ...
         {
            _loc8_ = IFocusExtras(param1);
            _loc9_ = _loc8_.focusExtrasAfter;
            if(_loc9_)
            {
               _loc11_ = false;
               if(param2)
               {
                  _loc7_ = _loc9_.indexOf(param2) - 1;
                  _loc4_ = _loc7_ >= -1;
                  _loc11_ = !_loc4_;
               }
               else
         ...
         if(param2 && !_loc4_)
         {
            _loc7_ = param1.getChildIndex(param2) - 1;
            _loc4_ = _loc7_ >= -1;
         }
         else
         {
         ...
         if(param1 is IFocusExtras)
         {
            _loc9_ = _loc8_.focusExtrasBefore;
            if(_loc9_)
            {
               _loc11_ = false;
               if(param2 && !_loc4_)
      ...
      protected function findNextContainerFocus(param1:DisplayObjectContainer, param2:DisplayObject, param3:Boolean) : IFocusDisplayObject
      {
         ...
         if(param1 is IFocusExtras)
         {
            ...
            _loc8_ = _loc6_.focusExtrasBefore;
            if(_loc8_)
            {
               _loc10_ = false;
               if(param2)
               {
                  _loc5_ = _loc8_.indexOf(param2) + 1;
                  _loc7_ = _loc5_ > 0;
                  _loc10_ = !_loc7_;
               }
               else
         ...
         if(param1 is IFocusExtras)
         {
            _loc8_ = _loc6_.focusExtrasAfter;
            if(_loc8_)
            {
               _loc10_ = false;
               if(param2 && !_loc7_)
