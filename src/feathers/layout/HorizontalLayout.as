package feathers.layout
{
   ...
   public class HorizontalLayout extends EventDispatcher implements IVariableVirtualLayout, ITrimmedVirtualLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         var _loc26_:Vector.<DisplayObject> = this._useVirtualLayout ? this._discoveredItemsCache : param1;
         var _loc27_:int = int(_loc26_.length);
         ...
         if(_loc20_ < _loc28_)
         {
            ...
            if(_loc44_ != 0)
            {
               ...
               {
                  _loc25_ = _loc26_[_loc32_];
                  if(!(_loc25_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc25_).includeInLayout))
                  {
                     _loc25_.x += _loc44_;
                  }
                  _loc32_++;
         ...
         {
            _loc25_ = _loc26_[_loc32_];
            _loc7_ = _loc25_ as ILayoutDisplayObject;
            if(!(_loc7_ && !_loc7_.includeInLayout))
            {
               ...
               else
               {
                  if(_loc7_)
                  {
                     _loc23_ = _loc7_.layoutData as HorizontalLayoutData;
                     if(_loc23_)
                     {
                        ...
                        if(_loc16_ === _loc16_)
                        {
                           ...
                           {
                              _loc10_ = IFeathersControl(_loc25_);
                              _loc48_ = Number(_loc10_.minHeight);
                              if(_loc8_ < _loc48_)
                              {
                                 _loc8_ = _loc48_;
                              }
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         if(_loc19_)
         {
            _loc10_ = _loc4_ + this._paddingTop + this._paddingBottom;
            if(_loc10_ < _loc16_)
            {
               _loc10_ = _loc16_;
            }
      ...
      public function getVisibleIndicesAtScrollPosition(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int> = null) : Vector.<int>
      {
         ...
         if(!this._hasVariableItemDimensions)
         {
            ...
            _loc30_ = (param1 - this._paddingLeft) / (_loc23_ + this._gap);
            if(_loc30_ < 0)
            {
               _loc30_ = 0;
            }
            _loc30_ -= _loc27_;
            _loc28_ = _loc30_ + _loc25_;
            if(_loc28_ >= param5)
            {
               _loc28_ = param5 - 1;
            }
            _loc30_ = _loc28_ - _loc25_;
            if(_loc30_ < 0)
            {
               _loc30_ = 0;
            }
         ...
         while(_loc22_ < param5)
         {
            ...
            _loc10_ = _loc12_;
            _loc12_ += _loc17_ + _loc16_;
            if(_loc12_ > param1 && _loc10_ < _loc19_)
            {
               param6[_loc7_] = _loc22_;
               _loc7_++;
            }
         ...
         var _loc21_:int = _loc25_ - _loc29_;
         if(_loc21_ > 0 && _loc29_ > 0)
         {
            _loc13_ = param6[0];
         ...
         _loc21_ = _loc25_ - _loc29_;
         if(_loc21_ > 0)
         {
            _loc14_ = int(_loc29_ > 0 ? param6[_loc29_ - 1] + 1 : 0);
            _loc15_ = _loc14_ + _loc21_;
            if(_loc15_ > param5)
            {
               _loc15_ = param5;
            }
      ...
      public function getNearestScrollPositionForIndex(param1:int, param2:Number, param3:Number, param4:Vector.<DisplayObject>, param5:Number, param6:Number, param7:Number, param8:Number, param9:Point = null) : Point
      {
         ...
         else
         {
            ...
            _loc14_ = Math.abs(_loc13_ - param2);
            if(_loc14_ < _loc10_)
            {
               param9.x = _loc13_;
            }
         ...
         while(_loc23_ < _loc24_)
         {
            ...
            if(!(!_loc20_ || _loc20_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc20_).includeInLayout))
            {
               ...
               else if(_loc20_ is ILayoutDisplayObject)
               {
                  ...
                  _loc19_ = _loc9_.layoutData as HorizontalLayoutData;
                  if(_loc19_ !== null)
                  {
      ...
      protected function prepareTypicalItem(param1:Number) : void
      {
         ...
         else if(this._typicalItem is ILayoutDisplayObject)
         {
            ...
            _loc2_ = _loc4_.layoutData as VerticalLayoutData;
            if(_loc2_ !== null)
            {
         ...
         do
         {
            ...
            while(_loc9_ < _loc14_)
            {
               ...
               if(_loc7_)
               {
                  ...
                  {
                     _loc12_ = IFeathersControl(_loc7_);
                     _loc17_ = Number(_loc12_.minWidth);
                     if(_loc17_ > _loc20_)
                     {
                        _loc17_ = _loc20_;
                     }
      ...
      protected function calculateMaxScrollXOfIndex(param1:int, param2:Vector.<DisplayObject>, param3:Number, param4:Number, param5:Number, param6:Number) : Number
      {
         ...
         if(this._useVirtualLayout && !this._hasVariableItemDimensions)
         {
            ...
            else
            {
               ...
               _loc23_ = param1 - param2.length - this._beforeVirtualizedItemCount + 1;
               if(_loc23_ < 0)
               {
                  _loc23_ = 0;
               }
