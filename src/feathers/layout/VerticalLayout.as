package feathers.layout
{
   ...
   public class VerticalLayout extends EventDispatcher implements IVariableVirtualLayout, ITrimmedVirtualLayout, IGroupedLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         {
            _loc8_ = int(this._headerIndices.length);
            if(_loc8_ > 0)
            {
               _loc27_ = 0;
         ...
         var _loc39_:Vector.<DisplayObject> = this._useVirtualLayout ? this._discoveredItemsCache : param1;
         var _loc21_:int = int(_loc39_.length);
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            if(_loc37_ != 0)
            {
               ...
               {
                  _loc20_ = _loc39_[_loc42_];
                  if(!(_loc20_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc20_).includeInLayout))
                  {
                     _loc20_.y += _loc37_;
                  }
                  _loc42_++;
         ...
         {
            _loc20_ = _loc39_[_loc42_];
            _loc6_ = _loc20_ as ILayoutDisplayObject;
            if(!(_loc6_ && !_loc6_.includeInLayout))
            {
               ...
               else
               {
                  if(_loc6_)
                  {
                     _loc18_ = _loc6_.layoutData as VerticalLayoutData;
                     if(_loc18_)
                     {
                        ...
                        if(_loc33_ === _loc33_)
                        {
                           ...
                           {
                              _loc31_ = IFeathersControl(_loc20_);
                              _loc29_ = Number(_loc31_.minWidth);
                              if(_loc14_ < _loc29_)
                              {
                                 _loc14_ = _loc29_;
                              }
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         if(_loc4_)
         {
            _loc11_ = _loc20_ + this._paddingLeft + this._paddingRight;
            if(_loc11_ < _loc7_)
            {
               _loc11_ = _loc7_;
            }
      ...
      public function getVisibleIndicesAtScrollPosition(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int> = null) : Vector.<int>
      {
         ...
         if(!this._hasVariableItemDimensions)
         {
            ...
            _loc36_ = (param2 - this._paddingTop) / (_loc24_ + this._gap);
            if(_loc36_ < 0)
            {
               _loc36_ = 0;
            }
            _loc36_ -= _loc33_;
            _loc34_ = _loc36_ + _loc30_;
            if(_loc34_ >= param5)
            {
               _loc34_ = param5 - 1;
            }
            _loc36_ = _loc34_ - _loc30_;
            if(_loc36_ < 0)
            {
               _loc36_ = 0;
            }
         ...
         if(this._headerIndices && this._stickyHeader)
         {
            _loc9_ = int(this._headerIndices.length);
            if(_loc9_ > 0)
            {
               _loc31_ = 0;
         ...
         while(_loc26_ < param5)
         {
            ...
            _loc12_ = _loc14_;
            _loc14_ += _loc8_ + _loc18_;
            if(_loc14_ > param2 && _loc12_ < _loc23_)
            {
               param6[_loc7_] = _loc26_;
               _loc7_++;
            }
         ...
         var _loc25_:int = _loc30_ - _loc35_;
         if(_loc25_ > 0 && _loc35_ > 0)
         {
            _loc13_ = param6[0];
            _loc10_ = _loc13_ - _loc25_;
            if(_loc10_ < 0)
            {
               _loc10_ = 0;
            }
         ...
         if(_loc25_ > 0)
         {
            _loc16_ = int(_loc35_ > 0 ? param6[_loc35_ - 1] + 1 : 0);
            _loc17_ = _loc16_ + _loc25_;
            if(_loc17_ > param5)
            {
               _loc17_ = param5;
            }
      ...
      protected function validateItems(param1:Vector.<DisplayObject>, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         ...
         {
            _loc20_ = param1[_loc23_];
            if(!(!_loc20_ || _loc20_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc20_).includeInLayout))
            {
               if(_loc10_)
               {
                  ...
                  if(_loc20_ is IFeathersControl)
                  {
                     _loc12_ = IFeathersControl(_loc20_);
                     _loc12_.minWidth = param3;
                     _loc12_.maxWidth = param4;
                  }
               }
               else if(_loc20_ is ILayoutDisplayObject)
               {
                  _loc9_ = ILayoutDisplayObject(_loc20_);
                  _loc19_ = _loc9_.layoutData as VerticalLayoutData;
                  if(_loc19_ !== null)
                  {
                     ...
                     if(_loc13_ === _loc13_)
                     {
                        ...
                        _loc26_ = IMeasureDisplayObject(_loc20_);
                        _loc21_ = _loc26_.explicitMinWidth;
                     ...
                     if(_loc16_ === _loc16_)
                     {
                        ...
                        _loc26_ = IMeasureDisplayObject(_loc20_);
                        _loc15_ = _loc26_.explicitMinHeight;
      ...
      protected function prepareTypicalItem(param1:Number) : void
      {
         ...
         {
            _loc4_ = ILayoutDisplayObject(this._typicalItem);
            _loc3_ = _loc4_.layoutData as VerticalLayoutData;
            if(_loc3_ !== null)
            {
         ...
         do
         {
            ...
            while(_loc10_ < _loc14_)
            {
               ...
               if(_loc8_)
               {
                  ...
                  {
                     _loc11_ = IFeathersControl(_loc8_);
                     _loc21_ = Number(_loc11_.minHeight);
                     if(_loc21_ > _loc5_)
                     {
                        _loc21_ = _loc5_;
                     }
      ...
      protected function calculateMaxScrollYOfIndex(param1:int, param2:Vector.<DisplayObject>, param3:Number, param4:Number, param5:Number, param6:Number) : Number
      {
         ...
         if(this._useVirtualLayout && !this._hasVariableItemDimensions)
         {
            ...
            else
            {
               ...
               _loc22_ = param1 - param2.length - this._beforeVirtualizedItemCount + 1;
               if(_loc22_ < 0)
               {
                  _loc22_ = 0;
               }
