package feathers.layout
{
   ...
   public class VerticalSpinnerLayout extends EventDispatcher implements ISpinnerLayout, ITrimmedVirtualLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         var _loc20_:Vector.<DisplayObject> = this._useVirtualLayout ? this._discoveredItemsCache : param1;
         var _loc21_:int = int(_loc20_.length);
         ...
         var _loc16_:Boolean = this._repeatItems && _loc4_ > _loc5_;
         if(_loc16_)
         {
            _loc4_ += _loc12_;
         }
         ...
         {
            _loc19_ = _loc20_[_loc24_];
            _loc6_ = _loc19_ as ILayoutDisplayObject;
            if(!(_loc6_ && !_loc6_.includeInLayout))
            {
               if(_loc16_)
               {
                  _loc18_ = _loc32_ - _loc14_;
                  if(_loc18_ > 0)
                  {
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         var _loc17_:* = _loc8_;
         _loc12_ += (_loc5_ + _loc14_) * param1;
         _loc12_ = _loc12_ - _loc14_;
         if(_loc4_)
         {
            _loc9_ = _loc17_ + this._paddingLeft + this._paddingRight;
            if(_loc9_ < _loc6_)
            {
               _loc9_ = _loc6_;
            }
      ...
      public function getVisibleIndicesAtScrollPosition(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int> = null) : Vector.<int>
      {
         ...
         var _loc16_:Boolean = this._repeatItems && _loc10_ > param4;
         if(_loc16_)
         {
            _loc10_ += _loc12_;
            param2 %= _loc10_;
      ...
      protected function validateItems(param1:Vector.<DisplayObject>, param2:Number, param3:Number) : void
      {
         ...
         var _loc6_:* = this._horizontalAlign == "justify";
         var _loc4_:Boolean = _loc6_ && param2 === param2;
