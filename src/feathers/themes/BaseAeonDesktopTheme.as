package feathers.themes
{
   ...
   public class BaseAeonDesktopTheme extends StyleNameFunctionTheme
   {
      ...
      {
         var _loc5_:Image = new Image(this.calloutBackgroundSkinTexture);
         _loc5_.scale9Grid = CALLOUT_SCALE_9_GRID;
      ...
      {
         var _loc5_:Image = new Image(this.dangerCalloutBackgroundSkinTexture);
         _loc5_.scale9Grid = CALLOUT_SCALE_9_GRID;
         param1.backgroundSkin = _loc5_;
      ...
      {
         var _loc4_:Quad = new Quad(this.controlSize,this.controlSize,16711935);
         _loc4_.alpha = 0;
         param1.defaultSkin = _loc4_;
         var _loc5_:ImageSkin = new ImageSkin(null);
         _loc5_.setTextureForState("hover",this.quietButtonHoverSkinTexture);
