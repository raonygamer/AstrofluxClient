   ...
   public class TextFieldTextRenderer extends FeathersControl implements ITextRenderer, IStateObserver
   {
      ...
      override public function render(param1:Painter) : void
      {
         ...
         if(this.textSnapshot)
         {
            ...
            do
            {
               ...
               while(_loc11_ -= _loc12_, _loc11_ > 0);
      ...
      protected function measure(param1:Point = null) : Point
      {
         ...
         if(_loc7_)
         {
            ...
            _loc5_ = roundUpToNearest(_loc5_,0.05);
      ...
      protected function layout(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(_loc12_ >= 1 && _loc7_ >= 1 && this._nativeFilters && this._nativeFilters.length > 0)
            {
               ...
               _loc11_ = new BitmapData(_loc12_,_loc7_,true,16711935);
               _loc11_.draw(this.textField,HELPER_MATRIX,null,null,HELPER_RECTANGLE);
            ...
            _loc9_ = Starling.current.profile != "baselineConstrained";
            if(_loc9_)
            {
               if(_loc12_ > this._maxTextureDimensions)
               {
      ...
      protected function refreshSnapshot() : void
      {
         ...
         do
         {
            ...
            do
            {
               ...
               {
                  _loc7_ = Texture.empty(_loc10_.width / _loc3_,_loc10_.height / _loc3_,true,false,false,_loc3_);
                  _loc7_.root.uploadBitmapData(_loc10_);
               }
               _loc16_ = null;
               if(_loc15_ >= 0)
               {
               ...
               if(!_loc16_)
               {
                  _loc16_ = new Image(_loc7_);
                  _loc16_.pixelSnapping = true;
               ...
               {
                  _loc12_ = _loc16_.texture;
                  _loc12_.root.uploadBitmapData(_loc10_);
               }
               if(_loc7_)
               {
            ...
            while(_loc13_ -= _loc14_, _loc13_ > 0);
         ...
         if(this.textSnapshots)
         {
            ...
            {
               _loc16_ = this.textSnapshots[_loc6_];
               _loc16_.texture.dispose();
