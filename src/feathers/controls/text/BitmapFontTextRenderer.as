package feathers.controls.text
{
   ...
   public class BitmapFontTextRenderer extends FeathersControl implements ITextRenderer, IStateObserver
   {
      ...
      public function measureText(param1:Point = null) : Point
      {
         ...
         {
            _loc14_ = int(this._text.charCodeAt(_loc15_));
            ...
            {
               _loc16_ = _loc26_.getChar(_loc14_);
               if(!_loc16_)
               {
      ...
      protected function layoutCharacters(param1:MeasureTextResult = null) : MeasureTextResult
      {
         ...
         {
            _loc4_ = false;
            _loc18_ = int(_loc14_.charCodeAt(_loc20_));
            ...
            {
               _loc21_ = _loc32_.getChar(_loc18_);
               if(!_loc21_)
               {
               ...
               else
               {
                  ...
                  if(this._wordWrap || _loc23_)
                  {
                     _loc29_ = CHAR_LOCATION_POOL.length > 0 ? CHAR_LOCATION_POOL.shift() : new CharLocation();
                     _loc29_.char = _loc21_;
      ...
      protected function addCharacterToBatch(param1:BitmapChar, param2:Number, param3:Number, param4:Number, param5:Painter = null) : void
      {
         ...
         var _loc7_:Rectangle = _loc6_.frame;
         if(_loc7_)
         {
      ...
      protected function getTruncatedText(param1:Number) : String
      {
         ...
         while(_loc7_ < _loc2_)
         {
            _loc5_ = int(this._text.charCodeAt(_loc7_));
            ...
            if(_loc8_)
            {
               ...
               _loc11_ += _loc13_ + _loc8_.xAdvance * _loc6_;
               if(_loc11_ > param1)
               {
         ...
         if(_loc3_ >= 0)
         {
            ...
            while(_loc7_ < _loc2_)
            {
               _loc5_ = int(this._truncationText.charCodeAt(_loc7_));
               _loc8_ = _loc15_.getChar(_loc5_);
               if(_loc8_)
               {
                  _loc13_ = 0;
            ...
            {
               _loc5_ = int(this._text.charCodeAt(_loc7_));
               _loc12_ = Number(_loc7_ > 0 ? this._text.charCodeAt(_loc7_ - 1) : NaN);
               _loc8_ = _loc15_.getChar(_loc5_);
               if(_loc8_)
               {
                  _loc13_ = 0;
