package feathers.controls.text
{
   ...
   public class TextFieldTextEditor extends FeathersControl implements ITextEditor, INativeFocusOwner, IStateObserver
   {
      ...
      public function setFocus(param1:Point = null) : void
      {
         ...
         if(this.textField)
         {
            ...
            if(param1 !== null)
            {
               ...
               {
                  _loc13_ = this.textField.getCharBoundaries(this._pendingSelectionBeginIndex);
                  if(_loc13_)
                  {
                     _loc11_ = _loc13_.x;
      ...
      protected function refreshSnapshot() : void
      {
         ...
         {
            _loc7_ = Texture.empty(_loc2_.width / _loc3_,_loc2_.height / _loc3_,true,false,false,_loc3_);
            _loc7_.root.uploadBitmapData(_loc2_);
         ...
         else
         {
            ...
            _loc6_.root.uploadBitmapData(_loc2_);
         }
         if(this._updateSnapshotOnScaleChange)
         {
