   ...
   public class StageTextTextEditor extends FeathersControl implements IMultilineTextEditor, INativeFocusOwner
   {
      ...
      protected function refreshSnapshot() : void
      {
         ...
         if(!this.textSnapshot || this._needsNewTexture)
         {
            ...
            _loc8_ = Texture.empty(_loc3_.width / _loc4_,_loc3_.height / _loc4_,true,false,false,_loc4_);
            _loc8_.root.uploadBitmapData(_loc3_);
         ...
         {
            _loc6_ = this.textSnapshot.texture;
            _loc6_.root.uploadBitmapData(_loc3_);
         }
         this.getTransformationMatrix(this.stage,HELPER_MATRIX);
      ...
      protected function refreshViewPortAndFontSize() : void
      {
         ...
         var _loc9_:Starling = stageToStarling(this.stage);
         if(_loc9_ === null)
         {
         ...
         var _loc11_:Number = Math.round((this.actualWidth + _loc5_) * _loc7_ * _loc2_);
         if(_loc11_ < 1 || _loc11_ !== _loc11_)
         {
            _loc11_ = 1;
         }
         var _loc13_:Number = Math.round((this.actualHeight + _loc5_) * _loc7_ * _loc6_);
         if(_loc13_ < 1 || _loc13_ !== _loc13_)
         {
            _loc13_ = 1;
         }
