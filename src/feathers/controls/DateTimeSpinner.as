   ...
   public class DateTimeSpinner extends FeathersControl
   {
      ...
      protected function refreshLocale() : void
      {
         ...
         if(!this._formatter || this._formatter.requestedLocaleIDName != this._locale)
         {
            ...
            _loc5_ = this._formatter.getDateTimePattern();
            _loc3_ = int(_loc5_.indexOf("M"));
            _loc2_ = int(_loc5_.indexOf("d"));
      ...
      protected function refreshSelection() : void
      {
         ...
         if(this._editingMode === "date")
         {
            _loc11_ = this.yearsList.dataProvider;
            if(_loc11_)
            {
               _loc5_ = IntegerRange(_loc11_.data);
               if(_loc5_.minimum !== this._listMinYear || _loc5_.maximum !== this._listMaxYear)
               {
            ...
            else
            {
               ...
               _loc11_ = new ListCollection(_loc5_);
               _loc11_.dataDescriptor = new IntegerRangeDataDescriptor();
               this.yearsList.dataProvider = _loc11_;
            }
         }
         else
         {
            _loc6_ = this._maximum.time - this._minimum.time;
            _loc3_ = _loc6_ / 86400000;
            if(this._editingMode === "dateAndTime")
            {
               _loc7_ = this.dateAndTimeDatesList.dataProvider;
               if(_loc7_)
               {
               ...
               else
               {
                  ...
                  _loc7_ = new ListCollection(_loc1_);
                  _loc7_.dataDescriptor = new IntegerRangeDataDescriptor();
            ...
            if(_loc2_)
            {
               _loc12_ = IntegerRange(_loc2_.data);
               if(_loc12_.minimum !== _loc10_ || _loc12_.maximum !== _loc8_)
               {
      ...
      protected function refreshValidRanges() : void
      {
         ...
         var _loc12_:ListCollection = !!this.yearsList ? this.yearsList.dataProvider : null;
         if(_loc12_ && (_loc17_ !== this._minYear || _loc8_ !== this._maxYear))
         {
            _loc12_.updateAll();
         }
         var _loc4_:ListCollection = !!this.monthsList ? this.monthsList.dataProvider : null;
         if(_loc4_ && (_loc19_ !== this._minMonth || _loc9_ !== this._maxMonth))
         {
            _loc4_.updateAll();
         }
         var _loc14_:ListCollection = !!this.datesList ? this.datesList.dataProvider : null;
         if(_loc14_ && (_loc20_ !== this._minDate || _loc2_ !== this._maxDate))
         {
            _loc14_.updateAll();
         }
         var _loc5_:ListCollection = !!this.dateAndTimeDatesList ? this.dateAndTimeDatesList.dataProvider : null;
         if(_loc5_ && (_loc17_ !== this._minYear || _loc8_ !== this._maxYear || _loc19_ !== this._minMonth || _loc9_ !== this._maxMonth || _loc20_ !== this._minDate || _loc2_ !== this._maxDate))
         {
            _loc5_.updateAll();
         }
         ...
         var _loc16_:ListCollection = !!this.minutesList ? this.minutesList.dataProvider : null;
         if(_loc16_ && (_loc3_ !== this._minMinute || _loc18_ !== this._maxMinute))
         {
            _loc16_.updateAll();
         }
         if(this._showMeridiem)
...
class IntegerRangeDataDescriptor implements IListCollectionDataDescriptor
{
   ...
   {
      var _loc4_:IntegerRange = IntegerRange(param1);
      var _loc5_:int = _loc4_.maximum;
