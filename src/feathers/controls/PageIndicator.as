package feathers.controls
{
   ...
   public class PageIndicator extends FeathersControl
   {
      ...
      protected function touchHandler(param1:TouchEvent) : void
      {
         ...
         {
            _loc4_ = param1.getTouch(this,"ended",this.touchPointID);
            if(!_loc4_)
            {
               return;
            }
            ...
            if(_loc3_)
            {
               ...
               if(this._direction == "vertical")
               {
                  if(this._interactionMode === "precise")
                  {
                     ...
                     _loc5_ = Math.round(_loc7_ * (HELPER_POINT.y - this.symbols[0].y) / _loc2_);
                     if(_loc5_ < 0)
                     {
                        _loc5_ = 0;
                     }
               ...
               else if(this._interactionMode === "precise")
               {
                  ...
                  _loc5_ = Math.round(_loc7_ * (HELPER_POINT.x - this.symbols[0].x) / _loc6_);
                  if(_loc5_ < 0)
                  {
                     _loc5_ = 0;
                  }
         ...
         {
            _loc4_ = param1.getTouch(this,"began");
            if(!_loc4_)
            {
               return;
            }
