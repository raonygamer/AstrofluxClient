package feathers.controls
{
   ...
   public class Header extends FeathersControl
   {
      ...
      override protected function draw() : void
      {
         ...
         var _loc5_:Boolean = this.isInvalid("textRenderer");
         if(_loc5_)
         {
            this.createTitle();
         }
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         {
            _loc6_ = _loc18_;
            _loc6_ = _loc6_ + (this._paddingTop + this._paddingBottom);
            if(_loc10_ > 0)
            {
         ...
         {
            _loc17_ = _loc18_;
            _loc17_ = _loc17_ + (this._paddingTop + this._paddingBottom);
            if(_loc10_ > 0)
            {
      ...
      protected function layoutTitle() : void
      {
         ...
         {
            _loc7_ = this.actualWidth - _loc5_ - _loc3_;
            if(_loc7_ < 0)
            {
               _loc7_ = 0;
            }
         ...
         {
            _loc8_ = this.actualWidth - this._paddingLeft - this._paddingRight;
            if(_loc8_ < 0)
            {
               _loc8_ = 0;
            }
            _loc11_ = this.actualWidth - _loc5_ - _loc3_;
            if(_loc11_ < 0)
            {
               _loc11_ = 0;
            }
