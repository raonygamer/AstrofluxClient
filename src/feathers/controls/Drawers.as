   ...
   public class Drawers extends FeathersControl
   {
         ...
         if(!this.isTopDrawerOpen && !this.isRightDrawerOpen && !this.isBottomDrawerOpen && !this.isLeftDrawerOpen)
         {
            ...
            if(this._openGesture === "edge")
            {
               ...
               if(!_loc7_)
               {
                  if(this._rightDrawer && !this.isRightDrawerDocked)
                  {
                     _loc8_ = (this.actualWidth - _loc5_) / (DeviceCapabilities.dpi / Starling.contentScaleFactor);
                  ...
                  if(!_loc7_)
                  {
                     if(this._bottomDrawer && !this.isBottomDrawerDocked)
                     {
                        _loc9_ = (this.actualHeight - _loc4_) / (DeviceCapabilities.dpi / Starling.contentScaleFactor);
                     ...
                     if(!_loc7_)
                     {
                        if(this._leftDrawer && !this.isLeftDrawerDocked)
                        {
                           _loc6_ = _loc5_ / (DeviceCapabilities.dpi / Starling.contentScaleFactor);
      ...
      protected function openOrCloseTween_onUpdate() : void
      {
         ...
         if(this._clipDrawers && this._openMode === "below")
         {
            ...
            if(this._topDrawer !== null)
            {
               _loc10_ = this._topDrawer.mask as Quad;
               if(_loc10_ !== null)
               {
            ...
            if(this._rightDrawer !== null)
            {
               _loc10_ = this._rightDrawer.mask as Quad;
               if(_loc10_ !== null)
               {
                  _loc4_ = -_loc1_;
                  if(_loc6_)
            ...
            if(this._bottomDrawer !== null)
            {
               _loc10_ = this._bottomDrawer.mask as Quad;
               if(_loc10_ !== null)
               {
                  _loc8_ = -_loc9_;
                  if(_loc5_)
            ...
            if(this._leftDrawer !== null)
            {
               _loc10_ = this._leftDrawer.mask as Quad;
               if(_loc10_ !== null)
               {
