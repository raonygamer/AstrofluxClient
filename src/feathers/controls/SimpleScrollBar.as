   ...
   public class SimpleScrollBar extends FeathersControl implements IDirectionalScrollBar
   {
      ...
      protected function layout() : void
      {
         ...
         if(this._direction == "vertical")
         {
            ...
            _loc9_ = _loc11_ - this.thumb.height;
            _loc4_ = _loc9_ * (this._value - this._minimum) / _loc5_;
            if(_loc4_ > _loc9_)
            {
               _loc4_ = _loc9_;
            }
         ...
         else
         {
            ...
            _loc10_ = _loc14_ - this.thumb.width;
            _loc3_ = _loc10_ * (this._value - this._minimum) / _loc5_;
            if(_loc3_ > _loc10_)
            {
               _loc3_ = _loc10_;
            }
