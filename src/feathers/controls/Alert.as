   ...
   public class Alert extends Panel
   {
      ...
      override protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            _loc5_ = this.header.width + this._outerPaddingLeft + this._outerPaddingRight;
            if(_loc5_ > _loc2_)
            {
               _loc2_ = _loc5_;
            }
            if(this.footer !== null)
            {
               _loc8_ = this.footer.width + this._outerPaddingLeft + this._outerPaddingRight;
               if(_loc8_ > _loc2_)
               {
                  _loc2_ = _loc8_;
               }
         ...
         if(_loc10_)
         {
            ...
            if(this.footer !== null)
            {
               _loc7_ = this.footer.minWidth + this._outerPaddingLeft + this._outerPaddingRight;
               if(_loc7_ > _loc9_)
               {
                  _loc9_ = _loc7_;
               }
