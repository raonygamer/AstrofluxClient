package feathers.controls
{
   ...
   public class ButtonGroup extends FeathersControl
   {
      ...
      protected function button_triggeredHandler(param1:Event) : void
      {
         ...
         var _loc4_:int = int(this.activeButtons.indexOf(_loc2_));
