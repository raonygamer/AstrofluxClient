package feathers.controls
{
   ...
   public class Callout extends FeathersControl
   {
      ...
      protected static function positionBelowOrigin(param1:Callout, param2:Rectangle) : void
      {
         ...
         {
            _loc4_ = Starling.current.stage.stageWidth - param1.width - stagePaddingRight;
            if(_loc4_ < _loc3_)
            {
               _loc3_ = _loc4_;
            }
      ...
      protected function measureWithArrowPosition(param1:String) : Boolean
      {
         ...
         if(_loc2_ !== null)
         {
            _loc5_ = this._explicitMaxWidth - this._paddingLeft - this._paddingRight;
            if(_loc5_ < _loc2_.maxWidth)
            {
               _loc2_.maxWidth = _loc5_;
            }
            _loc31_ = this._explicitMaxHeight - this._paddingTop - this._paddingBottom;
            if(_loc31_ < _loc2_.maxHeight)
            {
      ...
      protected function layoutChildren() : void
      {
         ...
         if(this.currentArrowSkin !== null)
         {
            ...
            if(this._arrowPosition === "left")
            {
               ...
               _loc5_ = _loc8_ + this._paddingTop;
               if(_loc5_ > _loc4_)
               {
                  _loc4_ = _loc5_;
               }
               ...
               {
                  _loc9_ = _loc8_ + this._paddingTop + _loc13_ - this._leftArrowSkin.height;
                  if(_loc9_ < _loc4_)
                  {
                     _loc4_ = _loc9_;
                  }
            ...
            else if(this._arrowPosition === "right")
            {
               ...
               _loc21_ = _loc8_ + this._paddingTop;
               if(_loc21_ > _loc14_)
               {
                  _loc14_ = _loc21_;
               }
            ...
            else if(this._arrowPosition === "bottom")
            {
               ...
               {
                  _loc6_ = _loc1_ + this._paddingLeft + _loc17_ - this._bottomArrowSkin.width;
                  if(_loc6_ < _loc15_)
                  {
                     _loc15_ = _loc6_;
                  }
            ...
            else
            {
               ...
               {
                  _loc20_ = _loc1_ + this._paddingLeft + _loc17_ - this._topArrowSkin.width;
                  if(_loc20_ < _loc7_)
                  {
                     _loc7_ = _loc20_;
                  }
      ...
      protected function positionRelativeToOrigin() : void
      {
         ...
         var _loc8_:* = this._lastGlobalBoundsOfOrigin != null;
         if(_loc8_ && this._lastGlobalBoundsOfOrigin.equals(HELPER_RECT))
         {
            return;
         }
         if(!_loc8_)
         ...
         while(_loc6_ < _loc5_)
         {
            switch(_loc9_ = _loc2_[_loc6_])
            {
               ...
               case "left":
                  ...
                  _loc4_ = this._lastGlobalBoundsOfOrigin.x - this.actualWidth;
               ...
               default:
                  ...
                  _loc7_ = Starling.current.stage.stageHeight - this.actualHeight - (this._lastGlobalBoundsOfOrigin.y + this._lastGlobalBoundsOfOrigin.height);
