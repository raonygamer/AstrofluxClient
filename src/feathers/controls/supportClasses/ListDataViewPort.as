package feathers.controls.supportClasses
{
   ...
   public class ListDataViewPort extends FeathersControl implements IViewPort
   {
      ...
      override protected function draw() : void
      {
         ...
         if(!_loc12_ && _loc9_ && this._layout && this._layout.requiresLayoutOnScroll)
         {
            _loc12_ = true;
         }
      ...
      private function refreshLayoutTypicalItem() : void
      {
         ...
         if(!_loc8_ || !_loc8_.useVirtualLayout)
         {
         ...
         if(_loc2_ !== null)
         {
            if(this._dataProvider)
            {
               _loc5_ = this._dataProvider.getItemIndex(_loc2_);
               _loc4_ = _loc5_ >= 0;
            }
            if(_loc5_ < 0)
            {
         ...
         if(_loc2_ !== null)
         {
            _loc6_ = IListItemRenderer(this._rendererMap[_loc2_]);
            if(_loc6_)
            {
               _loc6_.index = _loc5_;
            }
            if(!_loc6_ && this._typicalItemRenderer)
            {
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_ = this._typicalItemRenderer;
                  _loc6_.data = _loc2_;
                  _loc6_.index = _loc5_;
                  if(_loc4_)
                  {
      ...
      private function refreshRenderers() : void
      {
         ...
         if(this._typicalItemRenderer)
         {
            if(this._typicalItemIsInDataProvider)
            {
               _loc6_ = this.factoryIDToStorage(this._typicalItemRenderer.factoryID);
               _loc2_ = _loc6_.inactiveItemRenderers;
               _loc5_ = _loc6_.activeItemRenderers;
               _loc4_ = int(_loc2_.indexOf(this._typicalItemRenderer));
               if(_loc4_ >= 0)
               {
                  _loc2_[_loc4_] = null;
               }
      ...
      private function findUnrenderedData() : void
      {
         ...
         var _loc13_:IVirtualLayout = this._layout as IVirtualLayout;
         var _loc18_:Boolean = _loc13_ && _loc13_.useVirtualLayout;
         if(_loc18_)
         {
         ...
         if(_loc2_)
         {
            ...
            _loc15_ = ITrimmedVirtualLayout(this._layout);
            _loc15_.beforeVirtualizedItemCount = _loc11_;
         ...
         while(_loc7_ < _loc6_)
         {
            _loc8_ = _loc18_ ? HELPER_VECTOR[_loc7_] : _loc7_;
            if(!(_loc8_ < 0 || _loc8_ >= _loc12_))
            {
               ...
               if(_loc1_)
               {
                  ...
                  {
                     _loc10_ = this.factoryIDToStorage(_loc1_.factoryID);
                     _loc9_ = _loc10_.activeItemRenderers;
                     _loc17_ = _loc10_.inactiveItemRenderers;
                     _loc9_[_loc9_.length] = _loc1_;
                     _loc5_ = int(_loc17_.indexOf(_loc1_));
                     if(_loc5_ < 0)
                     {
         ...
         if(this._typicalItemRenderer)
         {
            ...
            {
               _loc8_ = int(HELPER_VECTOR.indexOf(this._typicalItemRenderer.index));
               if(_loc8_ >= 0)
               {
      ...
      private function freeInactiveRenderers(param1:ItemRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc7_:Vector.<IListItemRenderer> = param1.activeItemRenderers;
         var _loc6_:int = int(_loc7_.length);
         var _loc9_:int = int(_loc5_.length);
         var _loc4_:* = param2 - _loc6_;
         if(_loc4_ > _loc9_)
         {
            _loc4_ = _loc9_;
         }
      ...
      private function createRenderer(param1:Object, param2:int, param3:Boolean, param4:Boolean) : IListItemRenderer
      {
         ...
         var _loc10_:ItemRendererFactoryStorage = this.factoryIDToStorage(_loc6_);
         var _loc7_:Vector.<IListItemRenderer> = _loc10_.inactiveItemRenderers;
