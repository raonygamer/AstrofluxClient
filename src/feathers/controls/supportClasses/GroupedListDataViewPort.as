package feathers.controls.supportClasses
{
   ...
   public class GroupedListDataViewPort extends FeathersControl implements IViewPort
   {
      ...
      private function refreshLayoutTypicalItem() : void
      {
         ...
         var _loc10_:IVirtualLayout = this._layout as IVirtualLayout;
         if(!_loc10_ || !_loc10_.useVirtualLayout)
         {
         ...
         if(_loc3_ !== null)
         {
            _loc11_ = IGroupedListItemRenderer(this._itemRendererMap[_loc3_]);
            if(_loc11_)
            {
            ...
            {
               _loc9_ = !this._typicalItemIsInDataProvider;
               if(_loc9_)
               {
               ...
               if(_loc9_)
               {
                  _loc11_ = this._typicalItemRenderer;
                  _loc11_.data = _loc3_;
                  _loc11_.groupIndex = _loc5_;
                  _loc11_.itemIndex = _loc2_;
               }
      ...
      private function refreshRenderers() : void
      {
         ...
         if(this._typicalItemRenderer)
         {
            if(this._typicalItemIsInDataProvider)
            {
               ...
               _loc5_ = int(_loc2_.indexOf(this._typicalItemRenderer));
               if(_loc5_ >= 0)
               {
      ...
      private function findUnrenderedData() : void
      {
         ...
         var _loc10_:IVirtualLayout = this._layout as IVirtualLayout;
         var _loc18_:Boolean = _loc10_ && _loc10_.useVirtualLayout;
         if(_loc18_)
         {
         ...
         {
            _loc21_ = this._dataProvider.getItemAt(_loc4_);
            _loc17_ = this._owner.groupToHeaderData(_loc21_);
            if(_loc17_ !== null)
            {
         ...
         if(this._typicalItemRenderer)
         {
            ...
            {
               _loc5_ = int(HELPER_VECTOR.indexOf(this._typicalItemRenderer.layoutIndex));
               if(_loc5_ >= 0)
               {
      ...
      private function findRendererForItem(param1:Object, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_)
         {
            ...
            {
               _loc9_ = this.factoryIDToStorage(_loc5_.factoryID,_loc5_.groupIndex,_loc5_.itemIndex);
               _loc8_ = _loc9_.activeItemRenderers;
               _loc6_ = _loc9_.inactiveItemRenderers;
               _loc8_[_loc8_.length] = _loc5_;
               _loc7_ = int(_loc6_.indexOf(_loc5_));
               if(_loc7_ < 0)
               {
      ...
      private function findRendererForHeader(param1:Object, param2:int, param3:int) : void
      {
         ...
         var _loc6_:* = undefined;
         var _loc7_:int = 0;
         var _loc8_:IGroupedListHeaderRenderer = IGroupedListHeaderRenderer(this._headerRendererMap[param1]);
         if(_loc8_)
         {
            ...
            _loc4_ = this.headerFactoryIDToStorage(_loc8_.factoryID);
            _loc5_ = _loc4_.activeHeaderRenderers;
      ...
      private function findRendererForFooter(param1:Object, param2:int, param3:int) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc6_:IGroupedListFooterRenderer = IGroupedListFooterRenderer(this._footerRendererMap[param1]);
         if(_loc6_)
         {
            ...
            _loc7_ = this.footerFactoryIDToStorage(_loc6_.factoryID);
            _loc5_ = _loc7_.activeFooterRenderers;
      ...
      private function renderUnrenderedData() : void
      {
         ...
         while(_loc6_ < _loc1_)
         {
            _loc8_ = int(this._unrenderedItems.shift());
            _loc5_ = int(this._unrenderedItems.shift());
            _loc4_ = int(this._unrenderedItems.shift());
         ...
         while(_loc6_ < _loc1_)
         {
            _loc8_ = int(this._unrenderedHeaders.shift());
            _loc4_ = int(this._unrenderedHeaders.shift());
         ...
         while(_loc6_ < _loc1_)
         {
            _loc8_ = int(this._unrenderedFooters.shift());
            _loc4_ = int(this._unrenderedFooters.shift());
            _loc3_ = this._dataProvider.getItemAt(_loc8_);
      ...
      private function recoverInactiveItemRenderers(param1:ItemRendererFactoryStorage) : void
      {
         ...
         var _loc4_:Vector.<IGroupedListItemRenderer> = param1.inactiveItemRenderers;
      ...
      private function recoverInactiveHeaderRenderers(param1:HeaderRendererFactoryStorage) : void
      {
         ...
         var _loc4_:Vector.<IGroupedListHeaderRenderer> = param1.inactiveHeaderRenderers;
         var _loc2_:int = int(_loc4_.length);
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function freeInactiveItemRenderers(param1:ItemRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc8_:Vector.<IGroupedListItemRenderer> = param1.activeItemRenderers;
      ...
      private function freeInactiveHeaderRenderers(param1:HeaderRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc6_:Vector.<IGroupedListHeaderRenderer> = param1.activeHeaderRenderers;
      ...
      private function createHeaderRenderer(param1:Object, param2:int, param3:int, param4:Boolean = false) : IGroupedListHeaderRenderer
      {
         ...
         var _loc9_:Vector.<IGroupedListHeaderRenderer> = _loc7_.inactiveHeaderRenderers;
      ...
      private function createFooterRenderer(param1:Object, param2:int, param3:int, param4:Boolean = false) : IGroupedListFooterRenderer
      {
         ...
         var _loc11_:FooterRendererFactoryStorage = this.footerFactoryIDToStorage(_loc7_);
         var _loc5_:Vector.<IGroupedListFooterRenderer> = _loc11_.inactiveFooterRenderers;
      ...
      private function groupToHeaderDisplayIndex(param1:int) : int
      {
         ...
         var _loc4_:Object = this._owner.groupToHeaderData(_loc9_);
         if(!_loc4_)
         {
            return -1;
         }
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            _loc4_ = this._owner.groupToHeaderData(_loc9_);
            if(_loc4_)
            {
               if(param1 == _loc5_)
               {
      ...
      private function locationToDisplayIndex(param1:int, param2:int) : int
      {
         ...
         while(_loc5_ < _loc3_)
         {
            ...
            _loc6_ = this._owner.groupToHeaderData(_loc10_);
            if(_loc6_)
            {
               _loc8_++;
            }
            ...
            _loc4_ = this._owner.groupToFooterData(_loc10_);
            if(_loc4_)
            {
               _loc8_++;
            }
      ...
      private function dataProvider_addItemHandler(param1:Event, param2:Array) : void
      {
         ...
         {
            _loc8_ = this.groupToHeaderDisplayIndex(_loc7_);
            if(_loc8_ >= 0)
            {
               _loc3_.addToVariableVirtualCacheAtIndex(_loc8_);
            }
            _loc9_ = this._dataProvider.getLength(_loc7_);
            if(_loc9_ > 0)
            {
               _loc10_ = _loc8_;
               if(_loc10_ < 0)
            ...
            _loc11_ = this.groupToFooterDisplayIndex(_loc7_);
            if(_loc11_ >= 0)
            {
      ...
      private function dataProvider_updateItemHandler(param1:Event, param2:Array) : void
      {
         ...
         else
         {
            ...
            {
               _loc5_ = this._dataProvider.getItemAt(_loc9_,_loc7_);
               if(_loc5_)
               {
                  _loc3_ = IGroupedListItemRenderer(this._itemRendererMap[_loc5_]);
                  if(_loc3_)
            ...
            _loc5_ = this._owner.groupToHeaderData(_loc11_);
            if(_loc5_)
            {
               _loc12_ = IGroupedListHeaderRenderer(this._headerRendererMap[_loc5_]);
               if(_loc12_)
               {
                  _loc12_.data = null;
                  _loc12_.data = _loc5_;
            ...
            _loc5_ = this._owner.groupToFooterData(_loc11_);
            if(_loc5_)
            {
               _loc8_ = IGroupedListFooterRenderer(this._footerRendererMap[_loc5_]);
               if(_loc8_)
               {
                  _loc8_.data = null;
                  _loc8_.data = _loc5_;
            ...
            this.invalidate("data");
            _loc4_ = this._layout as IVariableVirtualLayout;
            if(!_loc4_ || !_loc4_.hasVariableItemDimensions)
            {
               return;
            }
      ...
      private function dataProvider_updateAllHandler(param1:Event) : void
      {
         ...
         {
            _loc7_ = IGroupedListHeaderRenderer(this._headerRendererMap[_loc5_]);
            if(!_loc7_)
            {
               return;
            }
         ...
         {
            _loc6_ = IGroupedListFooterRenderer(this._footerRendererMap[_loc4_]);
            if(!_loc6_)
            {
               return;
            }
