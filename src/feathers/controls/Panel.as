   ...
   public class Panel extends ScrollContainer implements IFocusExtras
   {
      ...
      override protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            _loc4_ = this.header.width + this._outerPaddingLeft + this._outerPaddingRight;
            if(_loc4_ > _loc1_)
            {
               _loc1_ = _loc4_;
            }
            if(this.footer !== null)
            {
               _loc7_ = this.footer.width + this._outerPaddingLeft + this._outerPaddingRight;
               if(_loc7_ > _loc1_)
               {
                  _loc1_ = _loc7_;
               }
         ...
         if(_loc9_)
         {
            ...
            if(this.footer !== null)
            {
               _loc6_ = this.footer.minWidth + this._outerPaddingLeft + this._outerPaddingRight;
               if(_loc6_ > _loc8_)
               {
                  _loc8_ = _loc6_;
               }
