package feathers.controls
{
   ...
   public class ImageLoader extends FeathersControl
   {
      ...
      protected function loader_completeHandler(param1:flash.events.Event) : void
      {
         ...
         var _loc4_:Boolean = this._texture && this._texture.nativeWidth === _loc2_.width && this._texture.nativeHeight === _loc2_.height && this._texture.scale === this._scaleFactor && this._texture.format === this._textureFormat;
         if(!_loc4_)
         {
            this.cleanupTexture();
         }
