		...
		private function handleMessagePack(m:Message) : void {
			...
			try {
				...
				while(_local4 < m.length - 2) {
					...
					_local2 = m.getInt(_local4 + 1);
					switch(_local3) {
						case "missionUpdate":
							g.playerManager.updateMission(m,_local4 + 2);
							break;
						case "statsChanged":
							g.playerManager.updatePlayerStats(m,_local4 + 2);
							break;
						case "bossComponentDamaged":
							g.bossManager.damaged(m,_local4 + 2);
							break;
						case "bossComponentKilled":
							g.bossManager.killed(m,_local4 + 2);
							break;
						case "aiBoucning":
							g.projectileManager.handleBouncing(m,_local4 + 2);
							break;
						case "t":
							g.spawnManager.killed(m,_local4 + 2);
							break;
						case "s":
							g.turretManager.killed(m,_local4 + 2);
							break;
						case "r":
							g.shipManager.killed(m,_local4 + 2);
							break;
						case "h":
							g.playerManager.xpGain(m,_local4 + 2);
							break;
						case "i":
							g.playerManager.xpLoss(m,_local4 + 2);
							break;
						case "j":
							g.playerManager.damaged(m,_local4 + 2);
							break;
						case "k":
							g.shipManager.damaged(m,_local4 + 2);
							break;
						case "m":
							g.spawnManager.damaged(m,_local4 + 2);
							break;
						case "l":
							g.turretManager.damaged(m,_local4 + 2);
							break;
						case "b":
							g.playerManager.fire(m,_local4 + 2,_local2);
							break;
						case "a":
							g.shipManager.shipSync.playerCourse(m,_local4 + 2);
							break;
						case "p":
							g.shipManager.enemyFire(m,_local4 + 2);
							break;
						case "q":
							g.turretManager.turretFire(m,_local4 + 2);
							break;
						case "c":
							g.shipManager.shipSync.aiStateChanged(m,_local4 + 2);
							break;
						case "n":
							g.dropManager.tryBeamPickup(m,_local4 + 2);
							break;
						case "o":
							g.dropManager.tryPickup(m,null,_local4 + 2);
							break;
						case "playerWeaponChanged":
							g.playerManager.weaponChanged(m,_local4 + 2);
							break;
						case "AICharge":
							g.shipManager.shipSync.aiCharge(m,_local4 + 2);
							break;
						case "g":
							g.playerManager.hardenShield(m,_local4 + 2);
							break;
						case "d":
							g.shipManager.shipSync.playerUsedBoost(m,_local4 + 2);
							break;
						case "e":
							g.playerManager.convShield(m,_local4 + 2);
							break;
						case "f":
							g.playerManager.dmgBoost(m,_local4 + 2);
							break;
						case "u":
							g.dropManager.spawn(m,_local4 + 2,_local2 - 2);
							break;
						case "v":
							g.playerManager.powerUpHeal(m,_local4 + 2);
							break;
						case "x":
							g.playerManager.troonGain(m,_local4 + 2);
							break;
						case "z":
							g.bossManager.aiTeleport(m,_local4 + 2);
							break;
						default:
							Console.write("Error: invalid message type " + _local3);
							_local4 = m.length;
					}
					_local4 += _local2;
				}
				...
				g.client.errorLog.writeError("MSG PACK: " + e.toString(),"Type: " + _local3,e.getStackTrace(),{});
			}
		}
