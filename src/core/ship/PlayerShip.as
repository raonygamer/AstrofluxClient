...
public class PlayerShip extends Ship {
    ...
    public function addConvert():void {
        ...
        var artifact_regen_base:int = shieldRegen;
    ...
    public function startKillingSpreeEffect():void {
        var killingSpreeEffect:Vector.<core.particle.Emitter> = EmitterFactory.create("Go4yOCnz40u-tQvx7g9wNg", g, pos.x, pos.y, this, true);
    }
