package core.ship {
	...
	public class EnemyShip extends Ship {
		...
		public function calculateOrbitSpeed() : Point {
			...
			var _local6:Number = orbitAngle + angleVelocity * 33 / 1000 * (_local1 - orbitStartTime);
			var _local2:Number = orbitRadius * ellipseFactor * Math.cos(_local6);
			var _local4:Number = orbitRadius * Math.sin(_local6);
			var _local3:Number = orbitAngle + angleVelocity * 33 / 1000 * (_local1 - 33 - orbitStartTime);
			_local2 -= orbitRadius * ellipseFactor * Math.cos(_local3);
			_local4 -= orbitRadius * Math.sin(_local3);
			return new Point((_local2 * Math.cos(ellipseAlpha) - _local4 * Math.sin(ellipseAlpha)) * 1000 / 33,(_local2 * Math.sin(ellipseAlpha) + _local4 * Math.cos(ellipseAlpha)) * 1000 / 33);
		}
