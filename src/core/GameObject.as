	...
	public class GameObject {
		...
		public function switchTexturesByObj(obj:Object, textureAtlas:String = "texture_main_NEW.png") : void {
			...
			if(imgObj == null) {
				...
				if(imgObj.animate) {
					_local5 = int(imgObj.animationDelay == 0 ? 33 : 33 / imgObj.animationDelay);
				}
				if(oldImageObjKey != obj.bitmap) {
					_textures = _local3.getTexturesByKey(obj.bitmap,textureAtlas);
				}
			}
			...
			if(_mc == null) {
				_mc = new MovieClip(_textures,_local5);
				_mc.touchable = false;
