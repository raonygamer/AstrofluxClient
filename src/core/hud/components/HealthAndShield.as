...
public class HealthAndShield extends DisplayObjectContainer {
    ...
    public function load():void {
        ...
        var playerShieldBarBgr:starling.display.Image = new Image(textureManager.getTextureGUIByTextureName("shield_bar.png"));
        ...
        var playerShield:starling.display.Image = new Image(textureManager.getTextureGUIByTextureName("text_shield"));
