package core.hud.components {
	...
	public class SaleSpinner extends PopupMessage {
		...
		public function SaleSpinner(g:Game) {
			...
			this.g = g;
			var _local3:ImageButton = new ImageButton(previous,TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"),TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"));
			_local3.y = 200;
			_local3.x = 580;
			_local3.pivotX = _local3.width / 2;
			_local3.pivotY = _local3.height / 2;
			box.addChild(_local3);
			var _local2:ImageButton = new ImageButton(next,TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"),TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"));
			_local2.y = 200;
			_local2.x = 20;
			_local2.pivotX = _local2.width / 2;
			_local2.pivotY = _local2.height / 2;
			_local2.rotation = 3.141592653589793;
