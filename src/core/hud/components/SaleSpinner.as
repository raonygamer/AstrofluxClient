package core.hud.components
{
	...
	public class SaleSpinner extends PopupMessage
	{
		...
		public function SaleSpinner(g:Game)
		{
			...
			this.g = g;
			var _loc2_:ImageButton = new ImageButton(previous,TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"),TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"));
			_loc2_.y = 200;
			_loc2_.x = 580;
			_loc2_.pivotX = _loc2_.width / 2;
			_loc2_.pivotY = _loc2_.height / 2;
			box.addChild(_loc2_);
			var _loc3_:ImageButton = new ImageButton(next,TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"),TextureLocator.getService().getTextureGUIByTextureName("sale_spinner_arrow"));
			_loc3_.y = 200;
			_loc3_.x = 20;
			_loc3_.pivotX = _loc3_.width / 2;
			_loc3_.pivotY = _loc3_.height / 2;
			_loc3_.rotation = 3.141592653589793;
			box.addChild(_loc3_);
