...
public class DominationZone {
    ...
    public function DominationZone(g:Game, obj:Object, id:int) {
        ...
        var neutralZone:starling.display.Image = createZoneImg(obj, neutralColor, "neutral");
        enemyZone = createZoneImg(obj, enemyColor, "enemy");
        var img:starling.display.Image = new Image(textureManager.getTextureByTextureName("piratebay", "texture_body.png"));
