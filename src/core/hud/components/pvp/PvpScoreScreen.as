...
public class PvpScoreScreen extends PvpScreen {
    ...
    override public function load():void {
        ...
        var leaveButton:core.hud.components.Button = new Button(showConfirmDialog, Localize.t("Leave Match"), "negative");
        leaveButton.x = 560;
        leaveButton.y = 520;
    ...
    override public function update():void {
        ...
        _loc4_ += 60;
        _loc6_ += 30;
        var scrollArea:feathers.controls.ScrollContainer = new ScrollContainer();
        scrollArea.y = _loc6_;
        scrollArea.x = 4;
