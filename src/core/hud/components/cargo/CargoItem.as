package core.hud.components.cargo {
	...
	public class CargoItem extends Sprite {
		...
		public function CargoItem(g:SceneBase, table:String, item:String, type:String, amount:int) {
			...
			var _local6:Object = dataManager.loadKey(table,item);
			itemName = Localize.t(_local6.name);
			bgr = new Quad(6 * 60,30,2233873);
			addChild(bgr);
			var _local7:Texture = textureManager.getTextureGUIByKey(_local6.bitmap);
			itemImage = new Image(_local7);
