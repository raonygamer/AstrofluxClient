...
public class EliteTechBar extends Sprite {
    public function EliteTechBar(g:Game, nameText:String, descText:String, iconName:String, lvl:int, eliteTech:String, techSkill:TechSkill) {
        ...
        var icon:starling.display.Image = new Image(textureManager.getTextureGUIByTextureName(iconName + ".png"));
        var _name:core.hud.components.Text = new Text();
        var desc:core.hud.components.Text = new Text();
        var level:core.hud.components.Text = new Text();
