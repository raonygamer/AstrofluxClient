...
public class GroupListItem extends Sprite {
    public function GroupListItem(g:Game, group:Group) {
        ...
        var playerListItems:Vector.<core.hud.components.playerList.PlayerListItem> = new Vector.<PlayerListItem>();
        var separator:starling.display.Quad = new Quad(620, 2, 0x666666);
        super();
        this.g = g;
        this.group = group;
        _loc5_ = 0;
    ...
    override public function dispose():void {
        ...
        var playerListItems:Vector.<core.hud.components.playerList.PlayerListItem> = null;
    }
}
}
