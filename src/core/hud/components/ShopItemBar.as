...
public class ShopItemBar extends Sprite {
    ...
    public function ShopItemBar(g:Game, parent:Sprite, shopItem:Object, fluxCost:int) {
        ...
        var selectContainer:starling.display.Sprite = new Sprite();
        ...
        var nameText:core.hud.components.TextBitmap = new TextBitmap(0, 0, "font13");
        ...
        h = 0;
        specialWeapon = false;
        var SPECIAL_WEAPON_SPORE:String = "nRRv5U5g30adeYN9X2C78Q";
        var SPECIAL_WEAPON_X27S:String = "w3-ZtQ-y_kiefCpnvFo88A";
        var SPECIAL_WEAPON_BLOOD_CLAW:String = "P6XvSQpMr0q7kQUsjeHvwQ";
    ...
    private function addDescription(obj:Object):void {
        var _loc2_:ShopItemBarStats = new ShopItemBarStats(obj);
