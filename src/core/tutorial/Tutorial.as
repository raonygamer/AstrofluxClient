...
public class Tutorial {
    ...
    public static function clear():void {
        var _loc2_:int = 0;
        var _loc1_:CrewDialogBox = null;
        var _loc3_:int = int(dialogs.length);
        _loc2_ = _loc3_ - 1;
        while (_loc2_ > -1) {
            _loc1_ = dialogs[_loc2_];
            _loc1_.hide();
            _loc2_--;
        }
    }
    ...
    public function showIntroTutorial():void {
        ...
        var that:Tutorial;
        var introStartId:String = "intro start";
    ...
    public function showExploreAdvice(area:ExploreArea):void {
        ...
        var showExploreAdviceId:String = "explore areas";
    ...
    public function showCompressorAdvice():void {
        var dialogBox:CrewDialogBox;
        var showCompressorAdviceId:String = "compressor advice";
    ...
    public function showMissionCompleteAdvice():void {
        var dialogBox:CrewDialogBox;
        var showMissionCompleteAdviceId:String = "mission complete";
    ...
    public function showForumAdvice():void {
        var dialogBox:CrewDialogBox;
        var showForumAdviceId:String = "forum";
    ...
    public function showMissionCompleteText(mission:Mission, drop:String, text:String):void {
        ...
        dialogBox.show("<FONT COLOR=\'#FF4444\'>Mission Complete!</FONT>\n\n" + text + "\n\n\n", null, null, -1, function ():void {
            g.rpc("requestMissionReward", function (param1:Message):void {
                ...
                var _loc9_:DropBase = g.dropManager.getDropItems(_drop, g, _mission.created);
                var _loc7_:int = 0;
                for each(var _loc4_ in _loc9_.items) {
                    _loc8_ = _loc4_.table;
                    _loc2_ = _loc4_.item;
                    _loc3_ = Number(_loc4_.quantity);
                    g.myCargo.addItem(_loc8_, _loc2_, _loc3_);
                    g.textManager.createDropText(_loc4_.name, _loc3_, 20, 5000, 0xffffff, 24 * _loc7_);
                    _loc7_++;
                }
                ...
                var _loc6_:ISound = SoundLocator.getService();
                _loc6_.preCacheSound("7zeIcPFb-UWzgtR_3nrZ8Q");
    ...
    public function showFacebookInviteHint():void {
        var dialogBox:CrewDialogBox;
        var showFacebookInviteHintId:String = "facebook invites";
    ...
    public function showArtifactUpgradeAdvice():void {
        var dialogBox:CrewDialogBox;
        var showArtifactUpgradeAdviceId:String = "artifact upgrade";
    ...
    public function showCargoAdvice():void {
        var dialogBox:CrewDialogBox;
        var showCargoAdviceId:String = "cargo upgrade";
    ...
    public function showUpgradeAdvice():void {
        var dialogBox:CrewDialogBox;
        var showUpgradeAdviceId:String = "upgrade tree";
    ...
    public function showExploreAdvice2():void {
        var dialogBox:CrewDialogBox;
        var showExploreAdvice2Id:String = "can leave explore";
    ...
    public function showArtifactFound(area:ExploreArea):void {
        ...
        var name1:String;
        var dialogBox:CrewDialogBox;
        var showArtifactFoundId:String = "artifact found";
    ...
    public function showSendCrewHint():void {
        var dialogBox:CrewDialogBox;
        var showSendCrewHintId:String = "send crew to explore";
    ...
    public function showForgotCrewHint():Boolean {
        ...
        var name:String;
        var crew:int;
        var showForgotCrewHintId:String = "forgot crew on explore";
    ...
    public function showLandingHint(body:Body):void {
        var dialogBox:CrewDialogBox;
        var name:String;
        var showLandingHintId:String = "land on body";
    ...
    public function showKillSpawnerHint(b:Body):void {
        var dialogBox:CrewDialogBox;
        var showKillSpawnerHintId:String = "kill spawner";
    ...
    public function showShopLocationHint():void {
        var dialogBox:CrewDialogBox;
        var showShopLocationHintId:String = "weapon factory location";
    ...
    public function showShopAdvice():void {
        var dialogBox:CrewDialogBox;
        var showShopAdviceId:String = "weapon production";
    ...
    public function showWarpGateHint():void {
        var dialogBox:CrewDialogBox;
        var showWarpGateHintId:String = "warp gate location";
    ...
    public function showChangeWeapon():void {
        var dialogBox:CrewDialogBox;
        var showChangeWeaponId:String = "change weapon";
    ...
    public function showWarpGateAdvice():void {
        ...
        var showWarpGateAdviceId:String = "warp license";
    ...
    public function showMapTargetHint():void {
        var showMapTargetAdviceId:String = "map targets";
    ...
    public function showRecycleAdvice():void {
        var dialogBox:CrewDialogBox;
        var showRecycleAdviceId:String = "recycle";
    ...
    public function showSpecialUnlocks(area:ExploreArea):void {
        var specialType:int;
        var dialogBox:CrewDialogBox;
        var showSpecialUnlocksId:String = "special unlocks";
