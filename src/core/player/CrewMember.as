package core.player {
	...
	public class CrewMember {
		...
		public function set imageKey(imgkey:String) : void {
			...
			var _local3:Object = _local4.loadKey("Images",imgkey);
			if(_local3 == null || _local3.fileName == null) {
			...
			texture = _local2.getTextureGUIByTextureName(_local3.fileName);
		}
		...
		public function getToolTipText() : String {
			...
			var _local2:int = 0;
			_local3 = 0;
			while(_local3 < specials.length) {
				if(specials[_local3] >= 1) {
					_local1 += Area.SPECIALTYPEHTML[_local3] + "\n";
					_local2++;
				}
				_local3++;
			}
