...
public final class StarlingCameraFocus {
    public function StarlingCameraFocus(aStage:Stage, aStageContainer:DisplayObject, aFocusTarget:Object, aLayersInfo:Array, aAutoStart:Boolean = false) {
        ...
        var _targetLastX:Number = _targetCurrentX = focusTarget.x;
        var _targetLastY:Number = _targetCurrentY = focusTarget.y;
        trackStep = 5;
        swapStep = 10;
        zoomStep = 10;
        var _step:uint = trackStep;
        var _tempStep:uint = trackStep;
    ...
    public function update():void {
        ...
        var _targetLastX:Number = _targetCurrentX;
        var _targetLastY:Number = _targetCurrentY;
